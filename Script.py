class script(object):
    START_TXT = """<b>𝙷𝙴𝙻𝙾 {},\n𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 <a href=https://t.me/ArrowFlix><b>𝙰𝚁𝚁𝙾𝚆𝙵𝙻𝙸𝚇</b></a> 𝙸 𝙲𝙰𝙽 𝙷𝙴𝙻𝙿 𝚈𝙾𝚄 𝚃𝙾 𝙵𝙾𝚄𝙽𝙳 𝙰𝙽𝚈 𝚂𝙴𝚁𝙸𝙴𝚂 𝙰𝙽𝙳 𝙼𝙾𝚅𝙸𝙴𝚂 𝙹𝚄𝚂𝚃 𝚂𝙴𝙽𝙳 𝙽𝙰𝙼𝙴\nꜰᴏʀ ᴍᴏʀᴇ ʜᴇʟᴘ ʀᴇᴀᴅ ꜰʀᴏᴍ ᴛʜᴇ ᴍᴇɴᴜ ʙᴇʟᴏᴡ</b>"""
...
Request Again"""
    ...
    CUDNT_FND = """<b><i>
لم استطع تحديد ما كتبت ، تأكد من الكتابة بــ(الطريقة الصحيحة /Help)
𝖨 𝖼𝗈𝗎𝗅𝖽𝗇'𝗍 𝖿𝗂𝗇𝖽 𝖺𝗇𝗒𝗍𝗁𝗂𝗇𝗀 𝗋𝖾𝗅𝖺𝗍𝖾𝖽 𝗍𝗈 𝗍𝗁𝖺𝗍
𝖣𝗂𝖽 𝗒𝗈𝗎 𝗆𝖾𝖺𝗇 𝖺𝗇𝗒 𝗈𝗇𝖾 𝗈𝖿 𝗍𝗁𝖾𝗌𝖾?</i></b>"""

    I_CUDNT = """❌ <b>𝖨 𝖼𝗈𝗎𝗅𝖽𝗇'𝗍 𝖿𝗂𝗇𝖽 𝖺𝗇𝗒𝗍𝗁𝗂𝗇𝗀 𝗋𝖾𝗅𝖺𝗍𝖾𝖽 𝗍𝗈 𝗍𝗁𝖺𝗍\nلم استطع العثور عليه في قاعدة البيانات تأكد من كتابة الاسم الصحيح</b>\n\n‼ <b><i>Check The Correct Spelling Or Click /Help For Request Format</i></b>"""
...
• You Most Read This For More /Help
